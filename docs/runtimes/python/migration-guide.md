...
description: TableTheory Python runtime moving from raw AWS SDK usage to TableTheory.
runtime: python
source_doc: py/docs/migration-guide.md
generated: true
---

<!-- Code generated by scripts/sync-runtime-docs-site.py; DO NOT EDIT. -->
<!-- Source: py/docs/migration-guide.md -->

[Package-source copy](https://github.com/theory-cloud/TableTheory/blob/main/py/docs/migration-guide.md) · Generated into the site so runtime docs are searchable and linkable.
