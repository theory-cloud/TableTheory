...
description: TableTheory Python runtime install and run the first local CRUD flow.
runtime: python
source_doc: py/docs/getting-started.md
generated: true
---

<!-- Code generated by scripts/sync-runtime-docs-site.py; DO NOT EDIT. -->
<!-- Source: py/docs/getting-started.md -->

[Package-source copy](https://github.com/theory-cloud/TableTheory/blob/main/py/docs/getting-started.md) · Generated into the site so runtime docs are searchable and linkable.
