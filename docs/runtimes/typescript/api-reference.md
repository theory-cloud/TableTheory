...
description: TableTheory TypeScript runtime public API signatures and option shapes.
runtime: typescript
source_doc: ts/docs/api-reference.md
generated: true
---

<!-- Code generated by scripts/sync-runtime-docs-site.py; DO NOT EDIT. -->
<!-- Source: ts/docs/api-reference.md -->

[Package-source copy](https://github.com/theory-cloud/TableTheory/blob/main/ts/docs/api-reference.md) · Generated into the site so runtime docs are searchable and linkable.
