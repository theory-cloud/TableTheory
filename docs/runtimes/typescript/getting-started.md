...
description: TableTheory TypeScript runtime install and run the first local CRUD flow.
runtime: typescript
source_doc: ts/docs/getting-started.md
generated: true
---

<!-- Code generated by scripts/sync-runtime-docs-site.py; DO NOT EDIT. -->
<!-- Source: ts/docs/getting-started.md -->

[Package-source copy](https://github.com/theory-cloud/TableTheory/blob/main/ts/docs/getting-started.md) · Generated into the site so runtime docs are searchable and linkable.
